 ...
 * @author Kabir Khan
 */
public class OverbaardIssueEvent {
    private final Type type;
    private final String issueKey;
    private final String projectCode;
    private final Detail detail;

    private OverbaardIssueEvent(Type type, String issueKey, String projectCode, Detail detail) {
        this.type = type;
    ...
    public static OverbaardIssueEvent createDeleteEvent(String issueKey, String projectCode) {
        return new OverbaardIssueEvent(Type.DELETE, issueKey, projectCode, null);
    }
